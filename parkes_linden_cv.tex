...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Doctor of Philosophy}{2014 -- June 2019}
    \resumeSubheading
      {Swinburne University of Technology}{Melbourne, Australia}
      {Bachelor of Science (Psychology, Psychophysiology). Honors (capstone research project). First Class. Dux.}{2009 -- 2013}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Postdoctoral Research Fellow}{June 2019 - Present}
      \resumeItemListStart
        \resumeItem{Predictive Modeling}
          {Anomaly detection in normative models of brain development.}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      {Visiting Research Fellow}{2016 - 2017}
      \resumeItemListStart
        \resumeItem{Firebase}
          {Workflows for ingest and storage of data in Firebase. Wrote code to download and process data used by other scientists. Code available on request.}
      \resumeItemListEnd
